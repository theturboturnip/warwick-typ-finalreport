\begin{sidewaystable}
    ...
    \begin{tabular}{lp{0.2\linewidth}|p{0.4\linewidth}|m{0.2\linewidth}|c}
        ...
        % \newtest{}\label{test:sys:run:vizSpeed} & Try to compile on DCS systems & Should be able to compile and run the simulation on elements of the DCS system. & See \todoref{Results} & \testsuccess{} \\
    \end{tabular}
