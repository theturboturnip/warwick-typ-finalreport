...
A significant open-source toolkit is VTK\todocite{vtk.org}, first introduced in 1993\cite{VTKBook}, which powers multiple tools such as ParaView\todocite{paraview.org} and VisIt\todocite{wci.llnl.gov}.
