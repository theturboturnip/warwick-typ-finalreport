...
The only SIMD instructions CUDA allows are for integer vectors of 2x16-bit or 4x8-bit\todocite{\url{https://docs.nvidia.com/cuda/parallel-thread-execution/index.html\#data-movement-and-conversion-instructions-ld}}.
...
CUDA Graphs\todocite{https://developer.nvidia.com/blog/cuda-graphs/} are a CUDA feature that reduces CPU overhead by invoking a large amount of GPU work all at once, rather than with individual invocations.
