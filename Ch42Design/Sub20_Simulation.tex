...
In all other cases CUDA Unified Memory is used\todocite{UnifiedMemory}, which can be paged between the CPU and GPU on-demand without manually mapping it across.
