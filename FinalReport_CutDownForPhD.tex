...
\usepackage{listings}
\lstset{
    basicstyle=\color{gray!20!black}\ttfamily\itshape
}
\lstdefinestyle{inline}{
    columns=fullflexible,
    breaklines=false
}
% \code{} = Any code-like text that should be formatted in teletype
\newcommand{\code}[1]{\lstinline[style=inline]!#1!}
% \shell{} = Any other computer-like text such as file extensions, bash subcommands etc. that are not themselves code but should still be formatted similarly.
\newcommand{\shell}[1]{\lstinline[style=inline]!#1!}
...
\begin{spacing}{2}
	...
	\end{center}
	\begin{center}
	    \textbf{\large Samuel Stark - CS351 Final Report}\\
...
\begin{center}
    {\large{This is the first two chapters of my third-year dissertation.\\The full text can be found at \\\small \url{ https://github.com/theturboturnip/warwick-typ/blob/master/CS351\_Final\_Report\_ForPrinting.pdf}}}
	\vspace{20mm}
\end{center}
% \end{minipage}
\end{figurepage}
