...
This is a standard Vulkan extension which checks each Vulkan call to ensure the Vulkan specification (\todocite{VulkanSpec}) isn't violated.
...
However the default move constructor generated by C++ will just copy the data across if the data is \textit{TriviallyCopyable}\todocite{cppref TriviallyCopyable copied instead of moved}, which is true for pointers and all CUDA handles.
