...
Each Runner defines a virtual interface, such as \code{IFixedTimeRunner} for the \code{FixedTimedRunner}.
...
This allows the \code{FixedTimeRunner} to define a single virtual function \code{runForTime(t)} instead of calling a virtual function every simulation tick.
