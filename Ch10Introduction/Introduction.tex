...
Rather than storing simulation output to huge datafiles before visualizing them, visualization is done in parallel with the simulation\todocite{https://www.cs.uoregon.edu/Reports/AREA-201703-Kress.pdf}.
